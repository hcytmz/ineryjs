...
JSON RPC Sample code are available at [example](https://github.com/hcytmz/ineryjs/blob/master/example/) directory, you can try to modify and understand how it works, you also need to have Valued Smart Contract ( Task 3 ) in your Account, to able run your code and call the valued contract function.
...
1. Clone the repo
   ...
   ```
   git clone https://github.com/hcytmz/ineryjs.git
   ```
